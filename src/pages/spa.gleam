    ...
    <div class='flex flex-col items-center justify-center'>
        ...
        <div class='min-h-screen flex flex-col items-center p-4 sm:p-6 md:p-8'>
            ...
            <div class='w-full text-gray-300 max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
                <p>The entire application is sent to the client, along with a JS script that fetches the
                    numbers from the server and renders them on the client side.</p>
                <p>This allows for smoother interactions but may increase initial load times.</p>
            </div>
        </div>
    </div>
    </body>
